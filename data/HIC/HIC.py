...
from common.utils.transforms import rigid_transform_3D
from common.utils.vis import save_obj, vis_keypoints, vis_mesh
...
class HIC(torch.utils.data.Dataset):
    ...
    def print_eval_result(self, eval_result):
        tot_eval_result = {"mpvpe_sh": [], "mpvpe_ih": [], "mrrpe": []}
