...
from common.utils.preprocessing import generate_patch_image, load_img, process_bbox
...
# snapshot load
model_path = "./pretrained/InterWild_snapshot_6.pth.tar"
...
for img_path in tqdm(img_path_list):
    ...
    for h in ("right", "left"):
        ...
        if h == "right":
            ...
            save_obj(
                mesh + rel_trans.reshape(1, 3), mano.face[h], osp.join(mesh_save_path, file_name + "_" + h + ".obj")
            )
